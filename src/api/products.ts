...
function mapProductRow(product: ProductRow): Product {
  ...
  return {
    ...
    ea_per_b: product.ea_per_b ?? productMaster?.ea_per_b ?? null,
    box_per_p: product.box_per_p ?? productMaster?.box_per_p ?? null,
    ea_per_p: product.ea_per_p ?? productMaster?.ea_per_p ?? null,
    pallets_per_truck: product.pallets_per_truck ?? productMaster?.pallets_per_truck ?? null,
